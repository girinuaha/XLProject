...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"  style="margin-top: 5%">
		<div class="row">
			...
			<div class="form-group col-sm-6">
				...
				<input class="form-control" id="contactsource" name="contactsource">
			</div>
			<div class="form-group col-sm-6">
	    		<label>Contact Type </label>
				<input class="form-control" id="contacttype" name="contacttype">
			</div>
		</div>
    ...
    <script src="../assets/bootstrap-4.0.0-alpha.6/docs/assets/js/ie10-viewport-bug-workaround.js"></script>
  	...
  	<script src="../assets/bootstrap-4.0.0-alpha.6/dist/js/validation.js"></script>
